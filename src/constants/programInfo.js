...
export const programLoanInfo = [
	// update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
	{
		...
		url: 'https://my.skills.fund/application?lenderCode=SKCARCD18',
		loanInfo: {
...
export const programMaxText =
	'Choose the loan amount that works best for you. Borrow up to $13,900 for tuition and up to $3,000 for cost of living.';
