import logo from "../images/logo_ccs.png" // add school logo to images folder and import here
...
export const schoolName = "Carolina Code School"

export const schoolURL = 'https://carolinacodeschool.org/' // update with url of school's website

export const skfURL = 'https://carolinacodeschool.skills.fund/' // update with Skills Fund url

export const headline = "Learn to Code at Carolina Code School" // update headline as appropriate

export const leadContent = {
    header: "Your last step on the path toward changing your career",
    paragraph: `${schoolName} designs its program to provide students a foundation for a career in software development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving ? ' and cost of living' : ''} financing so more students like you can access their program.`
}
...
export const threeStepCardText = {
    ...
    step2: {
        ...
        text: "Carolina Code School focuses exclusively on its Web Development program."
    },
    step3: `You'll be on your way to an exciting career in tech as part of ${schoolName}'s powerful network.`
}

export const netlifyFormName = 'carolinacodeschool_contact'

export const GATracking = 'UA-68312423-1'

export const hubspotFormId = "9534d22b-152c-4c9a-bb27-ad056e0e0b96" // create Hubspot form, get form id after publishing
...
export const programLoanInfo = [ // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
    {
        ...
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKCARCD18",
...
export const programMaxText = "Choose the loan amount that works best for you. Borrow up to $13,900 for tuition and up to $3,000 for cost of living."
